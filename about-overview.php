	...
	<body>
		<div class="boxed blog">
			...
			<section class="flat-row section-about2">
				<div class="container">
					<div class="row">
						<div class="col-lg-9 content-tab">
							<div class="content-inner">
								<div class="wrap-counterimages">
									<div class="row">
										<div class="col-lg-4">
											<div class="featured-about">
												<img src="images/about/over.jpg" alt="image">
											</div>
										</div>
										<div class="col-lg-8">
					                        ...
					                        <div class="row">
					                        		...
					                        		<div class="counter style2">
							                            <div class="counter-content">
							                                <div class="counter-number">
							                                    <span class="numb-count" data-from="0" data-to="10" data-speed="1000" data-waypoint-active="yes">10</span>
							                                </div>
							                            </div>
					                        	...
					                        	<div class="col-md-4">
					                        		<div class="counter style2">
							                            <div class="counter-content">
							                                <div class="counter-number">
							                                    <span class="numb-count" data-from="0" data-to="30" data-speed="1000" data-waypoint-active="yes">30</span><span>k</span>
							                                </div>
							                            </div>
					                        	...
					                        	<div class="col-md-4">
					                        		<div class="counter style2">
							                            <div class="counter-content">
							                                <div class="counter-number">
							                                    <span class="numb-count" data-from="0" data-to="100" data-speed="1000" data-waypoint-active="yes">100</span>
							                                </div>
							                            </div>
								...
								<div class="flat-quote parallax parallax4">
									<div class="overlay-parallax"></div>
									<h2>Pay Monthly Bill Online</h2>
								...
								<div class="wrap-history clearfix">
									<div class="title-section left clearfix">
			                            <h2>Our history</h2>
			                            <p class="sub-title-section">Schriftindustrie. Lorem Ipsum ist in der Industrie bereits der Standard Demo-Text seit 1500, als ein unbekannter Schriftsteller eine Hand voll Wörter nahm und dies durcheinander warf um ein Musterbuch zu erstellen. </p>
			                        </div>
								...
								<div class="text-download clearfix">
									<div class="one-half">
										<h2>Want to know more about us?</h2>
										<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
										<p>Nemo ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora</p>
									</div>
									<div class="one-half last content-casesingle">
										<aside class="widget widget-brochure">
											<div class="brochure-box-title">
												<p>This awesome service brings full interest information for your purpose
												</p>
							...
							<div class="sidebar about">
								<aside class=" widget widget-tab">
									...
									<ul class="menu menu-tab">
										<li class="active"><a href="about-overview.html">Over view <i class="icon-expand"></i></a></li>
										...
										<li><a href="about-partners.html">Our Partners <i class="icon-happy"></i></a></li>
									</ul>
								...
								<aside class="widget widget-info">
									<div class="widget-featured">
										<img src="images/about/w1.jpg" alt="image">
									</div>
									<p>In your life, you may have any times facing financial issues.It’s good if you know how.</p>
								</aside>
							</div>
						</div>
					</div>
