								...
								<div class="wrap-title-partners">
			                        ...
			                        <div class="flat-become clearfix">
			                        	...
			                        	<div class="one-half text-right">
			                        		<a href="contact-v1.php" class="go-contact">CONTACT US</a>
			                        	</div>
			                        </div>
								</div>
							...
							<div class="sidebar about faq">
								<aside class=" widget widget-tab">
									...
									<ul class="menu menu-tab">
										<li><a href="about-overview.php">Over view <i class="icon-expand"></i></a></li>
										<li><a href="about-faq.php">Faqs<i class="icon-documents"></i></a></li>
										<li><a href="about-team.php">The teams <i class="icon-profile-male"></i></a></li>
										<li class="active"><a href="about-partners.php">Our Partners <i class="icon-happy"></i></a></li>
									</ul>
