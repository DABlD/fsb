		...
		<div class="boxed blog">
			...
			<section class="flat-row section-about2">
				<div class="container">
					<div class="row">
						<div class="col-lg-9">
							<div class="content-inner about-partners">
								<div class="wrap-title-partners">
									<div class="title-section left">
			                            <h2>Development Partners And Foundations</h2>
			                            <p class="sub-title-section">Foundations play an increasingly important role in key areas including financial inclusion for the poor as a way to improve living standards. <span>Gravita</span> works with foundations and charitable organizations, connecting them with businesses to fill critical gaps in the areas of environmental sustainability, health and education, rural development, and social entrepreneurship.</p>
			                            <p class="sub-title-section">We have further strengthened our ties with foundations, private partners, and social investors by joining the <span>Global Philanthropy Forum</span>, an organization dedicated to creating a community of partners committed to international causes.</p>
			                        </div>
			                        <div class="flat-become clearfix">
			                        	<div class="one-half text-left">
			                        		<a class="go-become" href="#">Become a close partner with us <i class="ion-ios-arrow-thin-right"></i></a>
			                        	</div>
			                        	<div class="one-half text-right">
			                        		<a href="contact-v1.html" class="go-contact">CONTACT US</a>
			                        	</div>
			                        </div>
								</div>
								<div class="row wrap-partners">
									...
									<div class="col-md-12 clearfix ">
										<div class="one-half">
											<div class="flat-partners clearfix">
												<div class="featured">
													<img src="images/client/p1.jpg" alt="image">
												</div>
												<div class="partners-info">	
													<div class="partners-subtitle">Technology company</div>
													<div class="partners-name">SASS COMPANY</div>
											...
											<div class="flat-partners clearfix">
												<div class="featured">
													<img src="images/client/p3.jpg" alt="image">
												</div>
												<div class="partners-info">	
													<div class="partners-subtitle">Marketing company</div>
													<div class="partners-name">LESS STORE</div>
													<div class="social-links">
														<a href="#" data-title="Facebook" class="facebook"><i class="fa fa-facebook"></i></a> 
														<a href="#" data-title="LinkedIn" class="linkedin"><i class="fa fa-linkedin"></i></a> 
														<a href="#" data-title="Google Plus" class="google-plus"><i class="fa fa-google-plus"></i></a>
											...
											<div class="flat-partners clearfix">
												<div class="featured">
													<img src="images/client/p5.jpg" alt="image">
												</div>
												<div class="partners-info">	
													<div class="partners-subtitle">Close partner</div>
													<div class="partners-name">JOOMLA!</div>
													<div class="social-links">
														<a href="#" data-title="Facebook" class="facebook"><i class="fa fa-facebook"></i></a> 
														<a href="#" data-title="LinkedIn" class="linkedin"><i class="fa fa-linkedin"></i></a> 
														<a href="#" data-title="Google Plus" class="google-plus"><i class="fa fa-google-plus"></i></a>
										...
										<div class="one-half">
											<div class="flat-partners clearfix">
												<div class="featured">
													<img src="images/client/p2.jpg" alt="image">
												</div>
												<div class="partners-info">	
													<div class="partners-subtitle">Close partner</div>
													<div class="partners-name">JQUERY</div>
													<div class="social-links">
														<a href="#" data-title="Facebook" class="facebook"><i class="fa fa-facebook"></i></a> 
														<a href="#" data-title="LinkedIn" class="linkedin"><i class="fa fa-linkedin"></i></a> 
														<a href="#" data-title="Google Plus" class="google-plus"><i class="fa fa-google-plus"></i></a>
											...
											<div class="flat-partners clearfix">
												<div class="featured">
													<img src="images/client/p4.jpg" alt="image">
												</div>
												<div class="partners-info">	
													<div class="partners-subtitle">Consultancy company</div>
													<div class="partners-name">GATI COMPANY</div>
													<div class="social-links">
														<a href="#" data-title="Facebook" class="facebook"><i class="fa fa-facebook"></i></a> 
														<a href="#" data-title="LinkedIn" class="linkedin"><i class="fa fa-linkedin"></i></a> 
														<a href="#" data-title="Google Plus" class="google-plus"><i class="fa fa-google-plus"></i></a>
											...
											<div class="flat-partners clearfix">
												<div class="featured">
													<img src="images/client/p6.jpg" alt="image">
												</div>
												<div class="partners-info">	
													<div class="partners-subtitle">Consultancy company</div>
													<div class="partners-name">ENVATO COMPANY!</div>
													<div class="social-links">
														<a href="#" data-title="Facebook" class="facebook"><i class="fa fa-facebook"></i></a> 
														<a href="#" data-title="LinkedIn" class="linkedin"><i class="fa fa-linkedin"></i></a> 
														<a href="#" data-title="Google Plus" class="google-plus"><i class="fa fa-google-plus"></i></a>
						...
						<div class="col-lg-3">
							<div class="sidebar about faq">
								<aside class=" widget widget-tab">
									<h3 class="widget-title">About</h3>
									<ul class="menu menu-tab">
										<li><a href="about-overview.html">Over view <i class="icon-expand"></i></a></li>
										<li><a href="about-faq.html">Faqs<i class="icon-documents"></i></a></li>
										<li><a href="about-team.html">The teams <i class="icon-profile-male"></i></a></li>
										<li class="active"><a href="about-partners.html">Our Partners <i class="icon-happy"></i></a></li>
									</ul>
