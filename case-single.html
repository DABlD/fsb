		            			...
		            			<div class="content clearfix">
		            				<div class="one-half">
		            					<div class="text text1">
		            						<h3>Want to know more about Finance Plus?</h3>
		            						<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
		            						<p>Nemo ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
		            						<div class="pie-chart">
		            				...
		            				<div class="one-half last">
										...
										<div class="text3">
											...
											<ul class="list-planning">
												<li><i class="ion-android-checkbox-outline"></i>Automate your business, so you can leave for days, weeks,</li>
												<li><i class="ion-android-checkbox-outline"></i>Hone sharp leadership skills to manage your team</li>
												<li><i class="ion-android-checkbox-outline"></i>Hone sharp leadership skills to manage your team</li>
												<li><i class="ion-android-checkbox-outline"></i>Manage your time so you’ll get more done in less time</li>
												<li><i class="ion-android-checkbox-outline"></i>Attract and retain quality, high-paying customers</li>
												<li><i class="ion-android-checkbox-outline"></i>Our renowned coaching programs will allow you to:</li>
											</ul>
										</div>
		            				</div>
								</div>
	            				<div class="wrap-tab clearfix">
	            					<h3>Research beyond the business plan</h3>
	            					<div class="flat-tabs">
	            						<ul class="menu menu-tab clearfix">
											<li><a href="#">Strategy 1</a></li>
											<li><a href="#">Strategy 2</a></li>
											<li class="active"><a href="#">Strategy 3</a></li>
										</ul>
											...
											<div class="content-inner">
												...
												<div class="list-info clearfix">
													<div class="flat-info">
														...
														<div class="image">
															<img src="images/about/tab1.jpg" alt="image">
														</div>
													</div>
													<div class="flat-info">
														<div class="info">
														...
														<div class="image">
															<img src="images/about/tab2.jpg" alt="image">
														</div>
													</div>
													<div class="flat-info">
														<div class="info">
														...
														<div class="image">
															<img src="images/about/tab3.jpg" alt="image">
														</div>
													</div>
												</div>
											</div>
		            		...
		            		<div class="sidebar case">
		            			<div class="project-case">
		            				...
		            				<ul class="project-list">
		            					<li><span>Date:</span> January 24, 2017</li>
		            					<li><span>Client:</span> Ceo Themesflat</li>
		            					<li><span>Category:</span> Invoicing</li>
		            					<li><span>Value:</span> Johnson Group, DN</li>
		            				</ul>
		            				<div class="buton-project">
		            					<a href="#" class="flat-button" title="">Project Profile</a>
		            				</div>
	            				</div>
