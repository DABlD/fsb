	...
	<body>
		<div class="boxed blog">
			...
			<!-- map -->
	        <section class="pdmap">
	        	<div class="flat-maps" data-address="The District Dasmariñas, Molino - Paliparan Road, Salawag, Dasmariñas, Cavite" data-height="398" data-images="images/map/map-1.png" data-name="Ravita Map"></div>
	            <div class="gm-map">	            
	                <div class="map"></div>                        
	            </div>
	        </section>
							...
							<div class="flat-form-info">
								...
								<form id="contactform"  method="post" action="./contact/contact-process.php" novalidate="novalidate" class="form-info">
									<div class="wrap-input clearfix">
										...
										<p class="input-info"><input type="email" name="email" id="email" value="" placeholder="Email Address*" required="required"></p>
										<p class="input-info"><input type="text" name="phone" id="phone" value="" placeholder="Phone numbers*" required="required"></p>
									</div>
									<p class="textarea-info clearfix"><textarea id="message-contact" name="message" placeholder="Message*" required="required"></textarea></p>
									<p class="submit-info text-center">
										<button type="submit" class="flat-button">Get In touch</button></p>
								</form> <!-- /.flat-form-info -->
							</div>
						</div> <!-- /.col-md-8 -->
