   ...
   'use strict'
    ...
    var retinaLogos = function() {
      var retina = window.devicePixelRatio > 1 ? true : false;
        if(retina) {
            $('.header .logo').find('img').attr({src:'./images/logo@2x.png',width:'161',height:'50'}); 
        }

        if(retina) {
            $('.top .logo').find('img').attr({src:'./images/logo@2x.png',width:'161',height:'50'}); 
        }

        if(retina) {
            $('#footer #logo-footer').find('img').attr({src:'./images/logo@2x.png',width:'161',height:'50'}); 
        }
    }; 
