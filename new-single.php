						...
						<div class="post-wrap">
							<article class="main-post">
								<div class="featured-post">
										<img src="images/blog/blog-single.jpg" alt="image" />
								</div><!-- /.featured-post -->
								<div class="entry-post-title">
									<h2 class="post-title">Within the construction industry as their overdraft</h2>
									<ul class="entry-meta">
								...
								<div class="entry-content">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
									</p>
									<p>
								...
								<div class="tags-links">
                                    <span>Tags: </span>
                                    <a href="#" rel="tag">Consultant,</a>
                                    <a href="#" rel="tag"> Business,</a>
                                    <a href="#" rel="tag"> Marketing</a>
                                </div>
                                <div class="administrator clearfix">
                                	<div class="box"><img src="images/blog/avatar-single.png" alt="image"></div>
							...
							<div class="blog-pagination">
								<ul class="flat-pagination clearfix">
									<li class="previous-post"><a href="#"><span class="meta-nav">Previous Post</span> Within the construction industry </a></li>
									<li class="next-post text-right"><a href="#" rel="next"><span class="meta-nav">Next Post</span> The construction industry ...</a></li>
								</ul><!-- /.flat-pagination -->
							</div>
                                            ...
                                            <article class="comment-body clearfix">           
                                                ...
                                                <div class="comment-text">
                                                    <div class="comment-metadata">
                                                        <span class="name"><a href="#">Themesflat</a></span>
                                                        <span class="date">24 Junuary, 2018 at 11:00 am</span>
                                                        <span class="comment-reply"><a href="#">Reply</a></span>
                                                    </div><!-- .comment-metadata -->
                                                    <div class="comment-content">
                                                        <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum et molestias excepturi sint occaecati cupiditate provident similique sunt in culpa qui off icia deserunt </p>
                                                    </div><!-- .comment-content -->
                                            	...
                                            	<li class="comment">
                                            		<article class="comment-body clearfix">
		                                                ...
		                                                <div class="comment-text">
		                                                    <div class="comment-metadata">
		                                                    	<span class="name">
		                                                        <a href="#">nichethemes</a></span>
		                                                        <span class="date">24 Junuary, 2018 at 11:00 am</span>
		                                                        <span class="comment-reply"><a href="#">Reply</a></span>
		                                                    </div><!-- .comment-metadata -->
		                                                    <div class="comment-content">
		                                                        <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum et molestias excepturi sint occaecati cupiditate provident similique sunt in culpa</p>
		                                                    </div><!-- .comment-content -->
                                    ...
                                    <div class="comment-respond" id="respond">
                                        ...
                                        <form novalidate="" class="comment-form" id="commentform" method="post" action="#">                          
                                            <div class="wrap-input clearfix">
	                                            <span class="comment-form-input comment-label"> 
	                                            	<input id="author" name="author" type="text" value="" size="30" placeholder="Your Name" maxlength="245" aria-required="true" required="required">
	                                            </span>
	                                            <span class="comment-form-input comment-label">
	                                                <input id="email" name="email" placeholder="Your mail" type="email" required="required">
	                                            </span> 
                                            </div>
                                            <span class="comment-form-comment comment-label">
                                                <textarea id="comment" name="comment" placeholder="Message" required="required"></textarea>
                                            </span>                     
                                            <span class="form-submit">
                                                <button class="flat-button comment-submit">Send Message</button>
                                            </span>
                                        </form>
                                    </div><!-- /.comment-respond -->
                                </div><!-- /.comments-area -->
					...
					<div class="col-lg-4">
						<div class="sidebar right">
							...
							<aside id="recent-post" class=" widget widget-recent">
								...
								<ul>
									<li>
										<h4><a href="#" title="">Why Do I Need To Use Financial ?</a></h4>
										<span>January 11, 2017</span>
									</li>
									<li>
										<h4><a href="#" title="">Why your sales forecast is off</a></h4>
										<span>January 11, 2017</span>
									</li>
									<li>
										<h4><a href="#" title="">6 tips to retain your top sales talent</a></h4>
										<span>January 11, 2017</span>
									</li>
									<li>
										<h4><a href="#" title="">What the martian can teach sales</a></h4>
										<span>January 11, 2017</span>
									</li>
								</ul>
							</aside><!-- /.widget-recent -->
							...
							<aside class="widget widget-brochure">
								<div class="brochure-box-title">
									...
									<p>The Australian dollar has retained most of its gains against its US counterpart after surging to a 
									</p>
							...
							<aside class="widget widget-tags">
								...
								<div class="tag-cloud">
									...
									<a href="#" title="" class="tag-link">Consulting</a>
									<a href="#" title="" class="tag-link">Creative</a>
									<a href="#" title="" class="tag-link">Finanve</a>
									<a href="#" title="" class="tag-link">Insurance</a>
									<a href="#" title="" class="tag-link">Leasing</a>
								</div><!-- /.tag-cloud -->
							</aside><!-- /.widget-tags -->
						</div><!-- /.sidebar -->		
					</div><!-- /.col-lg-4 -->
