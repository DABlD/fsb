	...
	<body>
	    ...
	    <div class="preloader">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="page-title-heading">
								<h1 class="h1-title">Pricing</h1>
							</div><!-- /.page-title-heading -->
							<ul class="breadcrumbs">
								<li><a href="#" title="">Home<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
								<li><a href="#" title="">Page<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
								<li>Pricing</li>
							</ul><!-- /.breadcrumbs -->
			...
			<section class="flat-row section-pricing">
				<div class="container">
					<div class="row">
						<div class="col-lg-3 col-sm-6">
							<article class="flat-pricing text-center">
		                        ...
		                        <div class="btn-pricing">
		                            <button class="flat-button style2">Contact us</button>
		                        </div>
		                    </article>
						</div>
						<div class="col-lg-3 col-sm-6">
			...
			<section class="flat-row section-pricing2">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<div class="wrap-pricing table-responsive">
								<table class="table-pricing">
	                                <thead>
	                                    <tr>
	                                        <th></th>
	                                        <th class="text-center">Reference documents</th>
	                                        <th class="text-center">Duration</th>                  
	                                        <th class="text-center">Support time</th> 
	                                        <th class="text-center">Choose Consultant</th> 
	                                        <th></th> 
	                                    </tr>       
	                                </thead>
	                                <tbody>
	                                    <tr class="pricing_item">
	                                        <td class="title">
	                                        	Silver    
	                                        </td>
	                                        ...
	                                        <td class="text-center button">
	                                            <a href="#" class="flat-button style2">0$</a>
	                                        </td>
	                                    </tr>
	                                    <tr class="pricing_item sale">
	                                        <td class="title">
	                                        	Gold    
	                                        </td>
	                                        <td class="text-center">
	                                        ...
	                                        <td class="text-center button">
	                                            <a href="#" class="flat-button style2">80$</a>
	                                        </td>
	                                    </tr>
	                                    <tr class="pricing_item active">
	                                        <td class="title">
	                                        	Platinum    
	                                        </td>
	                                        <td class="text-center">
	                                        ...
	                                        <td class="text-center button">
	                                            <a href="#" class="flat-button style2">120$</a>
	                                        </td>
	                                    </tr>
	                                    <tr class="pricing_item">
	                                        <td class="title">
	                                        ...
	                                        <td class="text-center button">
	                                            <a href="#" class="flat-button style2">200$</a>
	                                        </td>
	                                    </tr>
	                                </tbody>
	                            </table>
